...
angular.module('conFusion.controllers', [])
  ...
  .controller('DishDetailController', ['$scope', '$stateParams', 'dish', '$ionicPopover', '$ionicListDelegate', '$ionicModal', '$timeout', 'favoriteFactory', 'menuFactory', 'baseURL', function ($scope, $stateParams, dish, $ionicPopover, $ionicListDelegate, $ionicModal, $timeout, favoriteFactory, menuFactory, baseURL) {
