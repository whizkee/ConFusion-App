...
.controller('DishDetailController', ['$scope', '$stateParams', '$ionicPopover', '$ionicListDelegate', '$ionicModal', '$timeout', 'favoriteFactory', 'menuFactory', 'baseURL', function ($scope, $stateParams, $ionicPopover, $ionicListDelegate, $ionicModal, $timeout, favoriteFactory, menuFactory, baseURL) {
...
// Implement the FavoritesController 
.controller('FavoritesController', ['$scope', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicListDelegate', '$ionicPopup', '$ionicLoading', '$timeout', function ($scope, menuFactory, favoriteFactory, baseURL, $ionicListDelegate, $ionicPopup, $ionicLoading, $timeout) {
  ...
  $ionicLoading.show({
    template: '<ion-spinner icon="ripple" class="spinner-royal"></ion-spinner> Loading...'
  });
